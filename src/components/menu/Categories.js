...
export class Categories extends React.Component {
    ...
    render() {
        ...
        return (
          <div className = "row">
            <div className="left">
              <h2 className="category" onClick={this.toEntrees}> Entrees </h2>
              <h2 className="category" onClick={this.toBurgers}> Burgers </h2>
              <h2 className="category" onClick={this.toSides}> Sides </h2>
